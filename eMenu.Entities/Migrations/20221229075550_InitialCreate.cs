        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kkal = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dishes_in_orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Dishes_in_orders_Dishes_DishId",
                        column: x => x.DishId,
                        principalTable: "Dishes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dishes_in_orders_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dishes_in_orders_DishId",
                table: "Dishes_in_orders",
                column: "DishId");

            migrationBuilder.CreateIndex(
                name: "IX_Dishes_in_orders_OrderId",
                table: "Dishes_in_orders",
                column: "OrderId");
